// Author: xiaotbl <3757246715@qq.com>
// License: WTFPL
...
#define FAT1_SECTORS 256  // FAT32需要更大的FAT表
#define ROOT_DIR_SECTORS 0  // FAT32根目录也是簇链式管理
#define FAT1_START_LBA 32  // 保留扇区后
#define ROOT_DIR_START_LBA 65
#define DATA_START_LBA (FAT1_START_LBA + FAT1_SECTORS * 2)  // 两个FAT表
...
typedef struct FILEINFO {
    ...
    uint16_t clustno_high;  // FAT32的高位簇号
    uint32_t size;
