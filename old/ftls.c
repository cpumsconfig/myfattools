...
#define FAT1_SECTORS 256
#define ROOT_DIR_SECTORS 0
#define FAT1_START_LBA 32
#define ROOT_DIR_START_LBA 65
#define DATA_START_LBA (FAT1_START_LBA + FAT1_SECTORS * 2)
